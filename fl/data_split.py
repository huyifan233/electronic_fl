...
def data_split():
    ...
    train_data_0_noniid = data[data['stabf'].isin([0])]
    train_data_1_noniid = data[data['stabf'].isin([1])]
    ...
    #
    train_data_0_noniid_df.to_csv(DATA_PATH_WIN_ROOT+"train_data_0_noniid.csv", index=0)
    train_data_1_noniid_df.to_csv(DATA_PATH_WIN_ROOT+"train_data_1_noniid.csv", index=0)
    # test_data_df.to_csv(DATA_PATH_WIN_ROOT+"test_data.csv", index=0)
